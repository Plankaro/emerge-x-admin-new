...
const VisionCardsAdminPanel: React.FC = () => {
  ...
  return (
    <div className=" flex flex-col w-full p-2  ">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-bold">Our Vision Cards</h1>
        <Button
      ...
      <div className=" w-[361px] sm:w-full overflow-x-auto">
      <table className="   border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            <th className="border px-4 py-2">Title</th>
            <th className="border px-4 py-2">Icon</th>
            <th className="border px-4 py-2 min-w-[900px]">Description</th>
...
export default VisionCardsAdminPanel;
